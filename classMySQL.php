...
$USUARIO				="";
$SENHA					="";
$link 	=	@mysql_connect($SERVIDOR, $USUARIO, $SENHA) or die ('1 - No foi possvel conectar ao Banco de Dados:'. mysql_error());
$con	=	@mysql_select_db ($BANCO) or die ('2 - No foi possvel selecionar o Banco de Dados:'. mysql_error());
